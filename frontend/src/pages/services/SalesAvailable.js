    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 200) {
                // Clear form fields upon successful submission using setFormData
                setFormData({
                    date: currentDate,
                    time: currentTime,
                    buildername: '',
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group">
                                    ...
                                    >
                                        ...
                                        {product1.map((material) => (
                                            <option key={material.id} value={material.price}>
                                                {material.price}
                                            </option>
                                        ))}
                                    </select>
                                    ...
                                    <tr key={`${registration.id}-${prodIndex}`}>
                                        {prodIndex === 0 ? (
                                            <>
                                                ...
                                                <td rowSpan={registration.products.length}>{registration.openingbal}</td>
                                        ...
                                        {prodIndex === 0 ? (
                                            <td rowSpan={registration.products.length}>
                                                <FaEdit style={{ color: 'green', textAlign: 'center', fontSize: '25px', cursor: 'pointer' }} className="edit-icon" onClick={() => handleEdit(registration)} />
                                            </td>
                                        ) : null}
                                        {prodIndex === 0 ? (
                                            <td rowSpan={registration.products.length}>
                                        ...
                                        {prodIndex === 0 ? (
                                            <td rowSpan={registration.products.length}>  {registration.id && <Link to={`/quotation/${registration.id}`}>
